    ...
    <main>
            ...
            <div class="owl-carousel owl-theme categories_carousel">
                <div class="item_version_2">
                    <a href="grid-listing-filterscol.html">
                        <figure>
                            <span>98</span>
                            <img src="{{asset('frontend/img/huio/pizza.jpg')}}" data-src="{{asset('frontend/img/huio/pizza.jpg')}}" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Pizza</h3>
                ...
                <div class="item_version_2">
                    <a href="grid-listing-filterscol.html">
                        <figure>
                            <span>87</span>
                            <img src="{{asset('frontend/img//huio/japaneese.jpg')}}" data-src="{{asset('frontend/img//huio/japaneese.jpg')}}" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Japanese</h3>
                ...
                <div class="item_version_2">
                    <a href="grid-listing-filterscol.html">
                        <figure>
                            <span>55</span>
                            <img src="{{asset('frontend/img/huio/burgers.jpg')}}" data-src="{{asset('frontend/img/huio/burgers.jpg')}}" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Burghers</h3>
                ...
                <div class="item_version_2">
                    <a href="grid-listing-filterscol.html">
                        <figure>
                            <span>55</span>
                            <img src="{{asset('frontend/img/huio/veg.jpg')}}" data-src="{{asset('frontend/img/huio/veg.jpg')}}" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Vegetarian</h3>
                                <small>Avg price $40</small>
                            </div>
                ...
                <div class="item_version_2">
                    <a href="grid-listing-filterscol.html">
                        <figure>
                            <span>65</span>
                            <img src="{{asset('frontend/img/huio/bakery.jpg')}}" data-src="{{asset('frontend/img/huio/bakery.jpg')}}" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Bakery</h3>
                ...
                <div class="item_version_2">
                    <a href="grid-listing-filterscol.html">
                        <figure>
                            <span>25</span>
                            <img src="{{asset('frontend/img/huio/chineese.jpg')}}" data-src="{{asset('frontend/img/huio/chineese.jpg')}}" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Chinese</h3>
                                <small>Avg price $40</small>
                            </div>
                ...
                <div class="item_version_2">
                    <a href="grid-listing-filterscol.html">
                        <figure>
                            <span>35</span>
                            <img src="{{asset('frontend/img//huio/mexican.jpg')}}" data-src="{{asset('frontend/img//huio/mexican.jpg')}}" alt="" class="owl-lazy" width="350" height="450">
                            <div class="info">
                                <h3>Mexican</h3>
        ...
        <div class="bg_gray">
            <div class="container margin_60_40">
                            ...
                            <ul>
                                <li>
                                    <a href="detail-restaurant.html">
                                        <figure>
                                            <img src="{{asset('frontend/img/huio/location_list_1.jpg')}}" data-src="{{asset('frontend/img/huio/location_list_1.jpg')}}" alt="" class="lazy" width="350" height="233">
                                        </figure>
                                ...
                                <li>
                                    <a href="detail-restaurant.html">
                                        <figure>
                                            <img src="{{asset('frontend/img/huio/location_list_2.jpg')}}" data-src="{{asset('frontend/img/huio/location_list_2.jpg')}}" alt="" class="lazy" width="350" height="233">
                                        </figure>
                                ...
                                <li>
                                    <a href="detail-restaurant.html">
                                        <figure>
                                            <img src="{{asset('frontend/img/huio/location_list_3.jpg')}}" data-src="{{asset('frontend/img/huio/location_list_3.jpg')}}" alt="" class="lazy" width="350" height="233">
                                        </figure>
                        ...
                        <div class="list_home">
                            <ul>
                                <li>
                                    <a href="detail-restaurant.html">
                                        <figure>
                                            <img src="{{asset('frontend/img/huio/location_list_4.jpg')}}" data-src="{{asset('frontend/img/huio/location_list_3.jpg')}}" alt="" class="lazy" width="350" height="233">
                                        </figure>
                                        <div class="score"><strong>9.5</strong></div>
                                        <em>Vegetarian</em>
                                        <h3>Mr. Pepper</h3>
                                ...
                                <li>
                                    <a href="detail-restaurant.html">
                                        <figure>
                                            <img src="{{asset('frontend/img/huio/location_list_5.jpg')}}" data-src="{{asset('frontend/img/huio/location_list_5.jpg')}}" alt="" class="lazy" width="350" height="233">
                                        </figure>
                                        <div class="score"><strong>8.0</strong></div>
                                        <em>Chinese</em>
                                        <h3>Dragon Tower</h3>
                                ...
                                <li>
                                    <a href="detail-restaurant.html">
                                        <figure>
                                            <img src="{{asset('frontend/img/huio/location_list_6.jpg')}}" data-src="{{asset('frontend/img/huio/location_list_6.jpg')}}" alt="" class="lazy" width="350" height="233">
                                        </figure>
                ...
                <!-- /row -->
                <div class="banner lazy" data-bg="url({{asset('frontend/img/huio/banner_bg_desktop.jpg')}})">
