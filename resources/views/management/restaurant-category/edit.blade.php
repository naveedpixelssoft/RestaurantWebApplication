    ...
    <div class="container-fluid px-4">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <form action="{{route('restaurant-category.update',$category->id)}}"  method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-8">
                                        ...
                                        <div class="col-12 my-2">
                                            <div class="main_container m-3">
                                                <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                    ...
                                                    <div class="img-thumb">
                                                        <img class="main_img d-block w-100 h-100 position-absolute" src="{{asset('images/restaurant-category'.'/'.$category->image)}}" height="60px" width="60px">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
