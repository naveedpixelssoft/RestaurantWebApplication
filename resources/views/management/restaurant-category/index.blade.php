                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title">Restaurant Categories</h4>
                            </li>
                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <a href="{{route('restaurant-category.create')}}" type="button" class="btn btn-primary"> Add New
                            </a>
                        </div>
                        ...
                        <div class="body table-responsive">
                            <table class="table" id="myTable">
                                ...
                                @foreach($category as $row)
                                    <tr>
                                        <td width="12%">
                                            <img style="" src="{{asset('images/restaurant-category'.'/'.$row->image)}}" height="60px" width="60px">
                                        </td>
                                        <td> {{$row->name}}</td>
                                        <td>
                                            @if($row->status == 1)
                                        ...
                                        <td>
                                            <a class="btn bg-blue btn-circle" href="{{route('restaurant-category.edit',$row->id)}}">
