                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <a href="{{route('menu.create')}}" type="button" class="btn btn-primary"> Add Menu
                            </a>
                        </div>
                        ...
                        <div class="body table-responsive">
                            <table class="table" id="myTable">
                                ...
                                @foreach($menu as $row)
                                    <tr>
                                        <td width="12%">
                                            <img style="" src="{{asset('images/menu'.'/'.$row->image)}}" height="60px" width="60px">
                                        </td>
                                        <td> {{$row->name}}
                                            <br>
                                            <small class="font-weight-bold text-uppercase">{{$row->category->name}}</small>
                                        </td>
                                        <td> USD {{$row->price}}</td>

                                        <td>
                                            <a class="btn bg-blue btn-circle" href="{{route('menu.edit',$row->id)}}">
